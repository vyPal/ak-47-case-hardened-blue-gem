<template>
    <div class="flex min-h-screen flex-col bg-gray-900 text-white">
                ...
                <div class="flex h-16 items-center justify-between">
                    ...
                    <div class="flex md:hidden">
                        <button
                            ...
                            class="inline-flex items-center justify-center rounded-md p-2 text-gray-400 transition-colors hover:bg-gray-700 hover:text-white focus:ring-2 focus:ring-purple-500 focus:outline-none focus:ring-inset"
                            aria-expanded="false"
                        >
        ...
        <!-- Mobile menu -->
        <div v-show="mobileMenuOpen" class="border-t border-gray-700 bg-gray-800 shadow-lg transition-all duration-200 md:hidden">
            <div class="space-y-2 px-4 pt-3 pb-4 sm:px-5">
                <Link
                    v-for="navItem in navigationItems"
                    :key="navItem.name"
                    :href="navItem.href"
                ...
                <div v-if="$page.props.auth?.user" class="mt-2 border-t border-gray-700 pt-5 pb-3">
                    ...
                    <div class="mt-4 space-y-2 px-2">
                        ...
                        <button
                            @click="logout"
                            class="block w-full rounded-md px-3 py-2 text-left text-base font-medium text-red-400 hover:bg-gray-700 hover:text-red-300"
                        >
                            Sign out
                        </button>
                    </div>
        ...
        <!-- Flash message -->
        <div v-if="$page.props.flash.success || $page.props.flash.error" class="z-10 mx-auto mt-4 max-w-7xl px-4 sm:px-6 lg:px-8">
